...
<head>
    ...
    <title>TheDocs components - Banner</title>
    ...
    <header class="site-header navbar-fullwidth">
      ...
      <div class="banner banner-full-height overlay-white" style="background-image: url(/img/banner2.jpg);">
        <div class="container text-left">
          <h1 class="text-teal"><strong>Scraper</strong></h1>
          ...
          <br>
          <p>
            <a class="btn btn-teal btn-lg text-uppercase" href="index-2.html" role="button"> Read documentation </a>
            <a class="btn btn-teal btn-lg btn-outline text-uppercase" href="http://themeforest.net/item/thedocs-online-documentation-template/13070884" role="button"> Getting started </a>
          </p>
        </div>
      </div>
      <!-- END Banner -->
